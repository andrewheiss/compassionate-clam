...
Kept the above chunks here, expecting there might be changes in the manual coding csv file, especially for the "need check" area coding
...
`work_field_code2` is an alternative code for the work field if the ONGO's work touches on overlapping fields
...
```{r}
model_control <- lm(geo_scope_num ~ work_field_code1 + local_connect + local_aim + psu_level + province_code, data = ongo)
