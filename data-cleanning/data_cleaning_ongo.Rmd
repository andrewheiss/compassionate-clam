...
`work_field` is the original mission statement in Chinese. The name "field" is chosen for the moment, because it seems "area" is more easily to be confused with the geographical scope
...
- `local_aim`
There are cases where the aim/mission of the ONGO is attached to a locality. So I created this dummy to indicate such situation. 
